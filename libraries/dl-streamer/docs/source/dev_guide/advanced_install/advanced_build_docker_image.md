...
<!--hide_directive:sync: tab1hide_directive-->
  ...
  ```bash
  wget https://raw.githubusercontent.com/open-edge-platform/edge-ai-libraries/release-2025.2.0/libraries/dl-streamer/docker/ubuntu/ubuntu24.Dockerfile
  ```
...
<!--hide_directive:sync: tab2hide_directive-->
  ...
  ```bash
  wget https://raw.githubusercontent.com/open-edge-platform/edge-ai-libraries/release-2025.2.0/libraries/dl-streamer/docker/ubuntu/ubuntu22.Dockerfile
  ```
