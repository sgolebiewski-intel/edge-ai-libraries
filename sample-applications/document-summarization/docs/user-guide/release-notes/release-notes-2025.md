# Release Notes: Document Summarization Sample Application 2025
...
- **Streamlined Build, Deployment and Documentation**: Added setup script to simplify service build and deployment processes and several other user guides. All supporting documents have been added.
