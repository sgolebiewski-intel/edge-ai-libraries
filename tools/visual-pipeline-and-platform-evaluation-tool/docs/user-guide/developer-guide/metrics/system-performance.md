...
[`vippet-telegraf.conf`](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.1.0/tools/visual-pipeline-and-platform-evaluation-tool/vippet-telegraf.conf)
