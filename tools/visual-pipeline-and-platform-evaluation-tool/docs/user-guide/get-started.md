...
- **System requirements**: The system meets the [minimum requirements](#system-requirements).
...
This section provides detailed hardware, software, and platform requirements to help set up and run the application
efficiently.
...
- Ensure all dependencies are installed and configured before proceeding to the guide below.
