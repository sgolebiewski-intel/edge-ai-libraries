...
### How to Use the Video Search Effectively
...
## How to Use the Video Summarization Effectively
...
Refer to the detailed [hardware and software requirements](./system-requirements.md).
