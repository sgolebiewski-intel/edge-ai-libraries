...
> [!NOTE]
> Since the parameters are unknown during deployment, these configurable pipelines
...
> [!NOTE]
> Refer to this [tutorial](./change-dlstreamer-pipeline.md) and this [section](../advanced-guide/detailed_usage/configuration/dlstreamer-ps-config.md) for configuration file.
