...
DL Streamer Pipeline Server microservice is built on top of `GStreamer <https://gstreamer.freedesktop.org/documentation/>`__ and `Deep Learning Streamer (DL Streamer) <https://github.com/open-edge-platform/edge-ai-libraries/tree/release-2025.2.0/libraries/dl-streamer>`__, providing video ingestion and deep learning inferencing functionalities.
